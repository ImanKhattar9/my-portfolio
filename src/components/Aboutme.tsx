        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-2 md:px-12">
          ...
          <div className="relative flex flex-col">
            ...
            <div className="relative flex flex-col flex-grow">
              <div className="absolute left-[15px] md:left-[30px] top-0 bottom-0 w-0.5 bg-gray-400"></div>
              ...
              {[
                ...
                <motion.div key={index} className="flex flex-col flex-grow">
                  <motion.div className="absolute left-[12px] md:left-[27px] w-2 h-2 bg-white rounded-full"
                    initial={{ opacity: 0, scale: 0 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                    viewport={{ once: true, amount: 0.5 }}
                    transition={{ duration: 0.6 }}
                  />
                  <motion.div className="border-2 shadow-md p-4 ml-4 mb-2 md:ml-12 flex flex-col flex-grow"
                    initial={{ opacity: 0, y: 50 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true, amount: 0.5 }}
                    transition={{ duration: 0.6 }}
                  >
                    <h4 className="text-lg font-semibold font-play">{item.title}</h4>
                    <p className="text-sm text-gray-500 font-eb">{item.date}</p>
          ...
          <div className="relative flex flex-col">
            ...
            <div className="relative flex flex-col flex-grow">
              ...
              {[
                { title: "Web Developer - Freelancer", date: "2023 - present", description: "Worked as a Web Developer, customizing themes and ensuring responsive design." },
